<template>
  ...
  <h1 class="text-indigo-600 font-bold font-sans text-4xl text-center">Login</h1>
    ...
    LoginPage,
      ...
      methods:{
        submit(){
            ...
            config.method="POST";
            config.body=JSON.stringify({email:this.email,password : this.password});

            fetch(constant.BACKEND_URL+'login',config).then(response => {
